...
$objPunto=new Punto;
$consulta=$objPunto->mostrar_puntos_historicos();
?>
...
if($consulta) {
        ...
        <?php
				...
				$objPunto->punto_historico_leido($punto['ID']);
				if ($i == 1) {
					echo '<br>LastID:<input type="text" size="50" id="campoLastID" value='.$punto['ID'].'>';
					echo '<br>LastLatitud:<input type="text" size="50" id="campoLastLatitud" value='.$punto['LATITUD'].'>';
					echo '<br>LastLongitud:<input type="text" size="50" id="campoLastLongitud" value='.$punto['LONGITUD'].'>';
