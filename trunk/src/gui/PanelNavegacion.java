...
public class PanelNavegacion extends javax.swing.JPanel implements java.util.Observer {
    ...
    private void initComponents() {
        ...
        panelTodo.setMinimumSize(new java.awt.Dimension(480, 910));
        panelTodo.setPreferredSize(new java.awt.Dimension(480, 910));
        ...
        panelDatosMapa.setMinimumSize(new java.awt.Dimension(480, 100));
        panelDatosMapa.setPreferredSize(new java.awt.Dimension(480, 100));
        ...
        panelTablaPOIs.setMinimumSize(new java.awt.Dimension(480, 200));
        panelTablaPOIs.setPreferredSize(new java.awt.Dimension(480, 200));
        ...
        panelBtnActualizar.add(btnActualizarMapa);
        ...
        panelMapa.add(panelBtnActualizar);
...
private void btnIniciarMapaNavActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarMapaNavActionPerformed
    ...
    if (!(controllers.ControladorPpal.getInstance().iniciaServerYabreBrowser())){
...
private void btnDetenerMapaNavActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetenerMapaNavActionPerformed
    ...
    if (!(controllers.ControladorPpal.getInstance().detieneServerYcierraBrowser())){
...
*/    
  ...
  public void update(Observable obs, Object arg){
      dataManager.Punto p = dataManager.Punto.getInstance();
      if (obs == p){
