...
public class PanelOpcAlertas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jXTable1.setMaximumSize(new java.awt.Dimension(480, 72));
        jXTable1.setMinimumSize(new java.awt.Dimension(480, 72));
        jXTable1.setPreferredScrollableViewportSize(new java.awt.Dimension(480, 250));
        jXTable1.setPreferredSize(new java.awt.Dimension(480, 72));
        jScrollPane1.setViewportView(jXTable1);
        jXTable1.getColumnModel().getColumn(0).setPreferredWidth(20);
        jXTable1.getColumnModel().getColumn(1).setMinWidth(300);
        jXTable1.getColumnModel().getColumn(1).setPreferredWidth(300);
        jXTable1.getColumnModel().getColumn(1).setMaxWidth(300);
        jXTable1.getColumnModel().getColumn(2).setResizable(false);
        jXTable1.getColumnModel().getColumn(2).setPreferredWidth(60);
