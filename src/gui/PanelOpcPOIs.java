...
public class PanelOpcPOIs extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(panelPois, java.awt.BorderLayout.CENTER);

        panelCategoriaPois.setMaximumSize(new java.awt.Dimension(500, 250));
        panelCategoriaPois.setMinimumSize(new java.awt.Dimension(500, 250));
        panelCategoriaPois.setPreferredSize(new java.awt.Dimension(500, 250));
        ...
        panelNombreNuevaCat.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 5, 15));

        lblNombreNuevaCat.setText("Descripción");
        ...
        panelBtnAgregaCategoria.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 5, 13));
        ...
        add(panelCategoriaPois, java.awt.BorderLayout.SOUTH);
